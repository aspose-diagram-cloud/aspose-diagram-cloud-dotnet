...
namespace Aspose.Diagram.Cloud.Live.Demos.UI.Config
{
	...
	public class AsposeDiagramCloudContext : Context
	{
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeDiagramCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeDiagramCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeDiagramCloudContext atcc { set { atc = value; } }
		internal static AsposeDiagramCloudContext Current
		{
			get { return atc; }
		}
